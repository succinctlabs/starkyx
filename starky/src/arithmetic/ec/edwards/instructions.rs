...
//     Den(Den<E::FieldParameters>),
//     FpAdd(FpAddInstruction<E::FieldParameters>),
//     FpMul(FpMulInstruction<E::FieldParameters>),
//     FpInnerProduct(FpInnerProductInstruction<E::FieldParameters>),
//     FpMulConst(FpMulConstInstruction<E::FieldParameters>),
//     Selector(Selector<FieldRegister<E::FieldParameters>>),
// }
...
//                 <Den<E::FieldParam> as Instruction<F, D>>::trace_layout(den)
//             }
//             EdWardsMicroInstruction::FpAdd(fp_add) => {
//                 <FpAddInstruction<E::FieldParam> as Instruction<F, D>>::trace_layout(fp_add)
//             }
//             EdWardsMicroInstruction::FpMul(fp_mul) => {
//                 <FpMulInstruction<E::FieldParam> as Instruction<F, D>>::trace_layout(fp_mul)
//             }
//             EdWardsMicroInstruction::FpInnerProduct(fp_quad) => {
//                 <FpInnerProductInstruction<E::FieldParam> as Instruction<F, D>>::trace_layout(
//                     fp_quad,
//                 )
//             }
//             EdWardsMicroInstruction::FpMulConst(fp_mul_const) => {
//                 <FpMulConstInstruction<E::FieldParam> as Instruction<F, D>>::trace_layout(
//                     fp_mul_const,
//                 )
//             }
//             EdWardsMicroInstruction::Selector(selector) => {
//                 <Selector<FieldRegister<E::FieldParam>> as Instruction<F, D>>::trace_layout(
//                     selector,
//                 )
//             }
//         }
...
// impl<E: EdwardsParameters> From<FpMulInstruction<E::FieldParameters>>
//     for EdWardsMicroInstruction<E>
// {
//     fn from(fp_mul: FpMulInstruction<E::FieldParameters>) -> Self {
//         EdWardsMicroInstruction::FpMul(fp_mul)
//     }
// }

// impl<E: EdwardsParameters> From<FpAddInstruction<E::FieldParameters>>
//     for EdWardsMicroInstruction<E>
// {
//     fn from(fp_add: FpAddInstruction<E::FieldParameters>) -> Self {
//         EdWardsMicroInstruction::FpAdd(fp_add)
//     }
// }

// impl<E: EdwardsParameters> From<FpInnerProductInstruction<E::FieldParameters>>
//     for EdWardsMicroInstruction<E>
// {
//     fn from(fp_quad: FpInnerProductInstruction<E::FieldParameters>) -> Self {
//         EdWardsMicroInstruction::FpInnerProduct(fp_quad)
//     }
// }

// impl<E: EdwardsParameters> From<FpMulConstInstruction<E::FieldParameters>>
//     for EdWardsMicroInstruction<E>
// {
//     fn from(fp_mul_const: FpMulConstInstruction<E::FieldParameters>) -> Self {
//         EdWardsMicroInstruction::FpMulConst(fp_mul_const)
//     }
// }

// impl<E: EdwardsParameters> From<Den<E::FieldParameters>> for EdWardsMicroInstruction<E> {
//     fn from(den: Den<E::FieldParameters>) -> Self {
//         EdWardsMicroInstruction::Den(den)
//     }
// }

// impl<E: EdwardsParameters> From<Selector<FieldRegister<E::FieldParameters>>>
//     for EdWardsMicroInstruction<E>
// {
//     fn from(selector: Selector<FieldRegister<E::FieldParameters>>) -> Self {
//         EdWardsMicroInstruction::Selector(selector)
//     }
// }
