...
mod tests {
    ...
    fn test_blake_2b_plonky_gadget() {
        ...
        let msg_target = CurtaBytes(builder.add_virtual_target_arr::<128>());
        ...
        let expected_digest_2 = "bddd813c634239723171ef3fee98579b94964e3bb1cb3e427262c8c068d52319";

        let long_msg = b"243f6a8885a308d313198a2e03707344a4093822299f31d0082efa98ec4e6c89452821e638d01377be5466cf34e90c6cc0ac29b7c97c50dd3f84d5b5b5470917".to_vec();
        println!("long_msg len = {}", long_msg.len());
        let expected_digest_long =
            "486ce0fdbd0e2f6b798d1ef3d881585b7a3331802a995d4b7fdf886b8b03a9a4";
        */
