...
use crate::chip::{self, AirParameters};
    ...
    > BLAKE2BBuilder<F, E, D, L> for CircuitBuilder<F, D>
{
    ...
    fn constrain_blake2b_gadget<C: CurtaConfig<D, F = F, FE = F::Extension>>(
        ...
        <plonky2::plonk::circuit_builder::CircuitBuilder<F, D> as chip::hash::blake::blake2b::builder_gadget::BLAKE2BBuilder<F, E, D, L>>::watch(self, "public_input_target", public_input_target);
